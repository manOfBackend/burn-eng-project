import { SignInErrorCode, SignUpErrorCode } from "@/types";
...
export const signUpErrorMessages: Map<SignUpErrorCode, string> = new Map<SignInErrorCode, string>([['too_many_requests', '요청이 너무 많습니다. 잠시 후 다시 시도해주세요.']])